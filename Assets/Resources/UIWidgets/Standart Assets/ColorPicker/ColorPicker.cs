	...
	public class ColorPicker : MonoBehaviour
	{
		...
		public ColorPickerImagePalette ImagePalette {
			...
			set {
				...
				{
					imagePalette.OnChangeRGB.RemoveListener(ColorImageChanged);
				}
				imagePalette = value;
				if (imagePalette!=null)
				{
					imagePalette.OnChangeRGB.AddListener(ColorImageChanged);
				}
			}
		}
		...
		protected virtual void ColorImageChanged(Color32 newColor)
		{
			color = newColor;
			UpdateBlocks(color);
		...
		/// </summary>
		/// <param name="newColor">New color.</param>
		protected virtual void ColorRGBChanged(Color32 newColor)
		{
			color = newColor;
			UpdateBlocks(color);
